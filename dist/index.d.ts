...
export declare function WindowControls({ platform, justify, hide, hideMethod, className, ...props }: WindowControlsProps): JSX_2.Element;
...
export declare function WindowTitlebar({ children, controlsOrder, className, windowControlsProps, ...props }: WindowTitlebarProps): JSX_2.Element;
